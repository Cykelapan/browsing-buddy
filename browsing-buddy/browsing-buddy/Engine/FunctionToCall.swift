...
enum FunctionToCall : String, Codable {
    ...
    func getValue(jsKey: JSElementKeys) -> String?{
        ...
        case .CLICK_ELEMENT_XPATH, .EXTRACT_LIST_BY_XPATH, .EXTRACT_TEXT_XPATH, .INSERT_ELEMENT_XPATH, .CLICK_ELEMENT_CLASS_HIGHLIGHT, .CLICK_ELEMENT_XPATH_HIGHLIGHT, .SCROLL_TO_ELEMENT_AND_SHOW_TEXT , .EXTRACT_BOOKED_TIMES_1177, .INSERT_ELEMENT_ID :
            return jsKey.xPath
